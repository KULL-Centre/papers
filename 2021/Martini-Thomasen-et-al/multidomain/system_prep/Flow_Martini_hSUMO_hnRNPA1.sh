...
EN_script=choose_rubber_bands_hSUMO_hnRNPA1.py
scFix_script=choose_scFix_dihedrals_hSUMO_hnRNPA1.py
...
#Starting structure
pdb=hSUMO_hnRNPA1.pdb

#Martinize
$python $martinize -f $pdb -o PRO_topol.top -x PRO_CG.pdb -ff $FF -cys auto -elastic -ef 700.0 -el 0.5 -eu 0.9 -ea 0 -ep 0 -scfix -ff-dir $ffdir/martini_v3.0.0_proteins/force_fields/ -map-dir $ffdir/martini_v3.0.0_proteins/mappings/ -ss 

#Put protein in box
$gmx editconf -f PRO_CG.pdb -o PRO_CG.gro -bt dodecahedron -d 4.8 <<EOF
1
EOF
...
nohup $gmx mdrun -deffnm min -v -ntomp 16 &
