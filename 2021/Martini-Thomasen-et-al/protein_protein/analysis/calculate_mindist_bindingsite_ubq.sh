...
$gmx mindist -f prodrun_nopbc.xtc -s prodrun.tpr -n data/ubq1_ubq2_lambda${i}_bindingsite.ndx -od data/ubq1_ubq2_mindist_lambda${i}_bindingsite.xvg -on data/ubq1_ubq2_numcont_lambda${i}_bindingsite.xvg -tu us -d 0.5 <<EOF 
