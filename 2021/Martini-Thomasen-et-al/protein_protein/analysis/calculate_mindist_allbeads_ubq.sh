...
$gmx mindist -f prodrun_nopbc.xtc -s prodrun.tpr -n data/ubq1_ubq2_lambda${i}.ndx -od data/ubq1_ubq2_mindist_lambda${i}.xvg -on data/ubq1_ubq2_numcont_lambda${i}.xvg -tu us -d 0.5 <<EOF 
a_1-166
a_167-332
EOF
