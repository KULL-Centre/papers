...
$gmx mindist -f prodrun_nopbc.xtc -s prodrun.tpr -n data/aSyn1_aSyn2_lambda${i}.ndx -od data/aSyn1_aSyn2_mindist_lambda${i}.xvg -on data/aSyn1_aSyn2_numcont_lambda${i}.xvg -tu us -d 0.8 <<EOF 
a_1-295
a_296-590
EOF
