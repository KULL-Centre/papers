...
$gmx mindist -f prodrun_nopbc.xtc -s prodrun.tpr -n data/FUS1_FUS2_lambda${i}.ndx -od data/FUS1_FUS2_mindist_lambda${i}.xvg -on data/FUS1_FUS2_numcont_lambda${i}.xvg -tu us -d 0.8 <<EOF 
a_1-371
a_372-742
EOF
