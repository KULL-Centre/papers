...
#define theta list
if j == 0:
    t_list =[200,250,300,400,500,1000,2000,3000,4000,5000,6000,7000,8000,9000,10000,11000,12000,13000,15000,17000,20000,25000,30000,40000,50000]
elif j == 1:
...
sim_file = 'calc_data_stage2_minusstart%d.dat' % j
