...
for combination in range(first_combination,last_combination+1):
    ...
    outfile_calc = 'calc_data_' + str(combination) + 'stage2.dat'
    ...
    for j in range(len(D)):
        ...
        footerlines = 0
        if D[j] == -1:
            data_filename = '/lindorffgrp-isilon/thomasen/hnRNPA1/FLA1_SAXSdata_08042020_averaged_newest/' + str(sys.argv[1])
            headerlines = 0
        else:
            data_filename = ''
            headerlines = 1
